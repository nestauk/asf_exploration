...
categories_short_names = {"After-sales (guarantees, workmanship warranties and warranty protection, after-sales support: customer service)":"After sales",
...
keywords_expressions = {"Issues": ["noise", "noises", "noisy", "damage", "damages", "damp", "mold", "moldy", "leak", "fan", "complain", "complaint", "complaints", "complained", "issue", "issues"],
                        "Performance": ["condensation", "heating", "hot water", "performance", "temperature", "cold", "weather", "weather compensation"],
                        "Industry/Schemes": ["ofgem", "feed in tariff", "manufacturer", "mcs", "ghg", "rhi", "code", "bus", "dno", "disctrict network"],
                        "Advice": ["information", "advice", "advise", "understand"],
                        "Finances": ["cost", "estimate", "installation cost", "quote", "deposit", "running costs", "bills"],
                        "Installation": ["installer", "installation", "installed", "installations"],
}

# Domain stopwords
domain_stopwords = ["consumer", "company", "ashp", "installation", "states", "signed", "advised", "contract", "reports", "installed", "installer", "recc"]
...
ngram_min = 1
ngram_max = 4
top_ngrams_variants = {"top_tokens_bigrams":{"generate_from_text":True, "text_process":"normal", "max_words": wordcloud_max_words},
                       "top_tokens_bigrams_stems":{"generate_from_text":True, "text_process":"stemming", "max_words": wordcloud_max_words},
                       "top_tokens_bigrams_lemmas":{"generate_from_text":True, "text_process":"lemmatising", "max_words": wordcloud_max_words},
                       "top_tokens_bigrams_category_estimates":{"generate_from_text":True, "text_process":"lemmatising", "max_words": wordcloud_max_words, "filter":"category:Estimates and quotes"},
                       "top_tokens_bigrams_category_complete_installation":{"generate_from_text":True, "text_process":"lemmatising", "max_words": wordcloud_max_words, "filter":"category:Completing the installation"},
                       "tf_idf_category_estimates":{"generate_from_text":True, "text_process":"lemmatising", "max_words": wordcloud_max_words, "filter":"category:Estimates and quotes", },
                       "tf_idf_category_complete_installation":{"generate_from_text":True, "text_process":"lemmatising", "max_words": wordcloud_max_words, "filter":"category:Completing the installation"},
                       }